...
// Handles periodic monster shooting once shooting has been unlocked by trigger zones.
public class MonsterShoot : MonoBehaviour
{
    [Header("Bullet")]
    // Bullet prefab that will be instantiated when the monster shoots.
    ...
    // Becomes true once the monster has entered one of the shooting zones.
