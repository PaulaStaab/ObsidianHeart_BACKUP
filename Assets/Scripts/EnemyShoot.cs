...
////        if (shootingZone1 == null) Debug.LogWarning("shootingZone(1) nicht gefunden oder hat keinen Collider.");
////        if (shootingZone2 == null) Debug.LogWarning("shootingZone(2) nicht gefunden oder hat keinen Collider.");
////        if (shootingZone3 == null) Debug.LogWarning("shootingZone(3) nicht gefunden oder hat keinen Collider.");
////    }
...
////        bool isInShootingZone = zonesInside > 0;
////        bool shootEnabled = testShoot || isInShootingZone;
...
//    private void Shoot()
//    {
//        Instantiate(bulletPrefab, shootPoint.position, shootPoint.rotation * Quaternion.Euler(0f, 180f, 0f));
//    }
//}
